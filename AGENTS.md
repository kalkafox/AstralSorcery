...
- `third_party/observerlib/` is a vendored copy of ObserverLib (a HellFirePvP library this mod
  depends on), currently integrated directly into the build during the port rather than as an
  external dependency.
